...
//            }
        ...
        $(document).on('click', '.j-actions', function() {
            var $btn = $(this),
                ...
                videoElems = '',
                // user = {
                //     id: +$.trim( $("#userCallerId").data('id') ),
                //     name: $.trim( $("#userCallerId").data('name') )
                // },
                mediaParams = {
                    'audio': {
            ...
            if ($btn.hasClass('hangup')) {
                if(!_.isEmpty(app.currentSession)) {
                    ...
                    $("#chat-modal .modal-header").show();
                    
                    $("#basicExampleModal").modal('hide');
                    $("#basicExampleModal .modal-header").show();
                    app.currentSession.stop({});
                    app.currentSession = {};
                ...
                if(isAudio) {
                    ...
                    document.querySelector('.j-actions[data-call="video"]').setAttribute('disabled', true);
                } else {
                    //document.querySelector('.j-actions[data-call="audio"]').setAttribute('disabled', true);
                }
        ...
        $(document).on('click', '.j-accept', function() {
            ...
            $("#chat-modal .modal-header").hide();

            $("#basicExampleModal").modal('show');
            $("#basicExampleModal .modal-header").hide();
...
//        });
        ...
        QB.webrtc.onSessionConnectionStateChangedListener = function onSessionConnectionStateChangedListener(session, userId, connectionState) {
            console.group('onSessionConnectionStateChangedListener.');
                console.log('UserID:', userId);
                console.log('Sessionfffff:', session);
...
}(window, window.QB, window.app, window.CONFIG,  $, Backbone));
