<!-- Developed By CBS -->
  ...
  @section('pageTitle', 'Nyeste Profiler')
  @push('style')
  @endpush
  @section('content')
    <!-- Main Content-->
            ...
            <!-- Main Section -->  
              <div class="col-lg-9 col-md-9">
                ...
                <div class="card-header custom-card-header">
                    <h6 class="card-title mb-0" style="font-weight: bold; text-transform:uppercase;">Nyeste Profiler</h6>
                </div>

                @if(sizeof($latestList) > 0)
                  <div class="row">
                        ...
                        <div class="card custom-card {{ $item->portalInfo->userNameColor }}" style="margin:20px;">
                          <a href="{{url('profile?user_id='.$item->id)}}" target="_blank">
                            <div class="card-body text-center">
                              ...
                              <p class="mb-2 mt-1 tx-inverse" style="font-weight: bold;">{{  str_limit($item->portalInfo->regionName, 25) }}</p>
                            </div>
                          </a>
                        </div>
                      </div>
