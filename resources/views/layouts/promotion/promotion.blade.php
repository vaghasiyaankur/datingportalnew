...
<div class="latest-news-bar-area">
    ...
    @if(auth()->user()->totalShowPromotion(1) != 0)
        ...
        ->slice(auth()->user()->totalShowPromotion(0) , 
                auth()->user()->totalShowPromotion(1)
                ) as $item)
...
<div class="modal fade " id="promotionModal" tabindex="-1" role="dialog" aria-labelledby="statusModalTitle" aria-hidden="true">
            ...
            <form id="promotionCreateForm" action="{{route('image-crop')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="container">
                   ...
                   <div class="form-group file-block">
                    ...
                    <input type="file" id="promotionInput" required name="file" accept=".png, .jpg, .jpeg" class="form-control-file">
                    </div>
                   
                    <div class="form-group row">
                        <div class="col-md-9">

                            <textarea maxlength="140" type="text" class="form-control" id="promotionTitle" name="promotionTitle" 
                            placeholder="Skriv din tekst her(Maks. 160 tegn)"></textarea>
                        </div>
                        <div class="col-md-2">
            ...
            <form id="statusForms" method="POST" action="{{ action('frontEnd\StatusController@store') }}" >
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" value="{{old('title')}}" placeholder="Titel her" required>
                    </div>
                    <div class="form-group">
                        <label for="status">Opslag</label>
                        <textarea maxlength="250" value="{{old('details')}}" placeholder="Skriv noget..." class="form-control" name="details" rows="3" required>
                        </textarea>
                    </div>
