...
<script>
	...
	document.write('<script type="text/javascript" src="https://alvarotrigo.com/fullPage/jquery.fullPage.min.js"><\/script>');
	}
</script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-backstretch/2.0.4/jquery.backstretch.min.js"></script>
{{-- <script src="{{asset('js/jquery.scrollify-1.0.19.js')}}"></script>
