<!-- Developed By CBS -->
  ...
  @section('pageTitle', 'Blog Redigere')
  @push('style')
                              ...
                              <div class="card item-card custom-card">
                                <div class="card-body h-100">
                                  <div class="modal-header">
                                      <h6 class="modal-title" style="font-weight: bold;text-transform: uppercase;">Rediger Blog</h6>
                                  </div>
                                  <!-- Image Section -->
                                  ...
                                  <!-- Image Section -->
                                  <!-- Event Data -->  
                                    <form method="POST" action="{{route('blog.blogupdate',$data->id)}}">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="row">
