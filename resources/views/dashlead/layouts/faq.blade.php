                ...
                <!-- Page Header -->
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                <div style="font-weight: bold; margin-bottom: 20px; text-transform:uppercase;"><h6 class="card-title mb-1">Ofte Stillede Spørgsmål ?</h6><hr></div>
                                        ...
                                        <div aria-labelledby="heading1" class="collapse" data-parent="#accordion" id="collapse1" role="tabpanel">
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    end de fleste andre datingsider, se vores <a style="display: contents;" data-toggle="modal"
                                                    data-target="#showPricesModal" href="#">priser</a> her.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
