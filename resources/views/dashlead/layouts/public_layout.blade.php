					...
					<!-- Header Menu -->
						<div class="main-navbar sticky">
							<div class="container">
								<ul class="nav">
									<li class="nav-item">
										<a class="nav-link" href="{{ route('public.home')}}" style="font-weight: bold; text-transform:uppercase;"><i class="fas fa-home"></i>HJEM</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" href="{{ route('public.tos')}}" style="font-weight: bold; text-transform:uppercase;"><i class="fas fa-file-contract"></i>Servicevilkår</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" href="{{ route('public.pp')}}" style="font-weight: bold; text-transform:uppercase;"><i class="fas fa-user-secret"></i>PRIVATLIVSPOLITIK</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" href="{{route('public.faq')}}" style="font-weight: bold; text-transform:uppercase;"><i class="fa fa-question-circle"></i>FAQ'S</a>
									</li>
