                                            ...
                                            <div id="editid"></div>
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="textarea" rows="10" placeholder="Write Something..." class="ckeditor form-control" name="detail" required>{{ isset($announcement->detail) ? $announcement->detail : ''}}</textarea>
                                                    </div>
                                                </div>
